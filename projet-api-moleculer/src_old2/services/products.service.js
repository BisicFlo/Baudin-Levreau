...
module.exports = {
	...
	actions: {
		...
		//	call "products.get" --id_product 74dcb92d-f290-4a9f-a91e-ac6cb71c9cc2
		get: {
			params: {
				id_product: "string"
			},
			handler(ctx) {
				...
				.then((exists) => {
					if (exists) {
						return Database()
							.then((db) => {
								var myProducts = db.get("products").find({ id: ctx.params.id_product }).value();;
								return myProducts;
							})
							.catch(() => {
								return new MoleculerError("Products", 500, "ERR_CRITIAL", { code: 500, message: "Critical error" } )
...
//_____________________________________________________________________________________
		//	call "products.increment" --id_product b1c56893-bcf7-4ef1-b8c5-05128a467521
...
//___________________________________________________________________
		//	call "products.decrement" --id_product b1c56893-bcf7-4ef1-b8c5-05128a467521
